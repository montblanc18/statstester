...
class TestStats(unittest.TestCase):
    ...
    def test_tdistribution(self):
        self.assertEqual(2.2753084029999999, tdistribution(100, 0.025))
        self.assertEqual(1.9837310030000002, tdistribution(100, 0.05))
        self.assertEqual(1.6600806299999999, tdistribution(100, 0.1))
